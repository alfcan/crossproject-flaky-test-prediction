...
public class CosineSimilarity {
	...
	public CosineSimilarity(String pPathToStopwordList) {
		this.stopwordList=new File(pPathToStopwordList);
	}
	...
	private String stem(String pWord) {
